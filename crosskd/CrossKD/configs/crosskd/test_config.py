...
model = dict(
    ...
    # Para usar uma loss customizada, preciso criar uma classe nn.Module no caminho mmdet/losses, criando um arquivo para 
    # a loss e sua respectiva classe.
    # Depois, defino a loss no init da pasta losses, para garantir que essa loss será exportada.
    # Por fim, apenas passo minha loss aqui , referenciando-a pelo nome da classe
    kd_cfg=dict(
        # Minha loss criada esta aqui
        loss_cls_kd=dict(type='CustomLoss', loss_weight=1.0),
