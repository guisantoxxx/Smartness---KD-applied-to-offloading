...
model = dict(
    ...
    kd_cfg=dict(
            # CQI será usado na loss combinada, pode definir aqui ou gerar aleatoriamente
            CQI=None,  # valor default ou None se quiser aleatório
            reused_teacher_head_idx=3,
            loss_cls_kd=dict(type='DummyLoss'),
            loss_reg_kd=dict(type='DummyLoss'),
        ),
