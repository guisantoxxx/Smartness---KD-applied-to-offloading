...
from .CQI_test_loss import CQILoss
from .big_loss import BigLoss
from .dummy_loss import DummyLoss

# É preciso incluir minha loss personalizada aqui
__all__ = [
    ...
    'SeesawLoss', 'DiceLoss', 'KDQualityFocalLoss', 'PKDLoss', 'CustomLoss', 'CQILoss', 'BigLoss'
]
