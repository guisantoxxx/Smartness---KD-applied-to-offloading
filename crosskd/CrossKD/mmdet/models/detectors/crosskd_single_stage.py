...
class CrossKDSingleStageDetector(SingleStageDetector):
    ...
    def __init__(
        ...
        super().__init__(
            # Guilherme: Define os valores passados no config
            backbone=backbone,
            neck=neck,
            bbox_head=bbox_head,
            train_cfg=train_cfg,
        ...
        # Guilherme: Congela o professor com uma funcao que desativa os gradientes
        self.freeze(self.teacher)

        # Guilherme: Constroi as losses a partir do arquivo de config
